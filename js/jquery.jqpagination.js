...
(function ($) {
	...
	$.jqPagination = function (el, options) {
		...
		base.$input = base.$el.find("#jqpinput" + options.cid);
		
		
		//alert(base.options.cid);
		...
		base.setPage = function (page, prevent_paged) {
			...
			base.$el.find('#jqpinput' + base.options.cid).attr("data-current-page",page);
