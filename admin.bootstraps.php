...
include_once(dirname(__FILE__).'/config/dbentity.config.php');
...
include_once(dirname(__FILE__).'/util/mdbo.class.php');
include_once(dirname(__FILE__).'/util/dbentity.class.php');